...
function preload(){
   ...
   "Images/HotAirBallon-01.png","Images/HotAirBallon-02.png","Images/HotAirBallon02.png",
...
function readHeight(data){
  ...
  height = data.val()
  balloon.x = height.x
  balloon.y = height.y //assign the x and y value of height to the respective x and y position of balloon
